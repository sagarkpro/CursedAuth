...
public interface UserService {
    ...
    BaseResponseDTO updatePassword(UpdatePasswordDto request);

    /**
     * Validates credentials (BCrypt + verified + active) and returns the
     * authenticated
     * user. Shared by the plain JSON login and the OAuth authorization-code login
     * path.
